...
impl BenchmarkBank {
    ...
    async fn split_coin_and_pay(
        ...
        let updated_gas = effects
            ...
            .map_err(Error::msg)?;
        Ok((
            (updated_gas.0, updated_gas.1, self.primary_gas.2.clone()),
            (updated_coin.0, updated_coin.1, self.primary_gas.2.clone()),
            transferred_coins?,
        ))
    }
}
